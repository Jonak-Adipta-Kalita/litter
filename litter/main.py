...
@click.group(context_settings=dict(ignore_unknown_options=True, allow_extra_args=True), epilog='Check out our repo at https://github.com/moiSentineL/litter for more details')
@click.argument('file')
@click.pass_context
def cli(ctx, file):
    """
...
def for_command(ctx, time):
    ...
    """
    upload("litterbox", ctx.obj['file'], time)
